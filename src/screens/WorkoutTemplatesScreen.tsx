...
const styles = StyleSheet.create({
  ...
  headerActionBtn: { paddingHorizontal: 10, paddingVertical: 6, backgroundColor: colors.surface, ...bevel.raised },
  ...
  codeInput: { textAlign: 'center', fontSize: 15, letterSpacing: 8, fontFamily: fonts.heading },
