...
export const ACTIVITY_TEMPLATES: ActivityTemplate[] = [
  ...
  },
  {
    ...
    baseXP: 200,
    category: 'learning',
    description: 'Algorithm problems, code katas, or competitive programming challenges',
    defaultCadence: '3x/week',
    availableCadences: ['daily', '6x/week', '5x/week', '4x/week', '3x/week', '2x/week', 'weekly'],
  },
  {
  ...
  {
    id: 'organization',
    activityName: 'Organise / Declutter',
    skillId: 'Construction',
    baseXP: 525,
    category: 'productivity',
    description: 'Declutter and organise a space in your home',
    defaultCadence: 'weekly',
    availableCadences: ['weekly', 'monthly'],
  },
  {
  ...
  // ===== SAILING =====
  // Real-world theme: navigation, adventure, exploring the world on water
  {
    id: 'sailing',
    ...
    baseXP: 630,
    category: 'hobby',
    description: 'Take a boat out — sail, navigate, and explore open water',
    defaultCadence: 'weekly',
    availableCadences: ['2x/week', 'weekly', 'monthly'],
  },
  {
    ...
    baseXP: 595,
    category: 'fitness',
    description: 'Ride waves — balance, timing, and reading the ocean',
    defaultCadence: 'weekly',
    availableCadences: ['2x/week', 'weekly', 'monthly'],
  },
  {
    id: 'rowing-sculling',
    activityName: 'Rowing / Sculling',
    skillId: 'Sailing',
    baseXP: 280,
    category: 'fitness',
    description: 'On-water or ergometer rowing — full body endurance on the water',
    defaultCadence: '2x/week',
    availableCadences: ['daily', '4x/week', '3x/week', '2x/week', 'weekly'],
  },
  {
    ...
    baseXP: 595,
    category: 'hobby',
    description: 'Paddle a canoe through rivers, lakes, or open water',
    defaultCadence: 'weekly',
    availableCadences: ['2x/week', 'weekly', 'monthly'],
  },
  {
    id: 'windsurfing-kiteboarding',
    activityName: 'Windsurfing / Kiteboarding',
    skillId: 'Sailing',
    baseXP: 630,
    category: 'hobby',
    description: 'Wind-powered water sport — technical, exhilarating, and freeing',
    defaultCadence: 'weekly',
    availableCadences: ['2x/week', 'weekly', 'monthly'],
  },
];
